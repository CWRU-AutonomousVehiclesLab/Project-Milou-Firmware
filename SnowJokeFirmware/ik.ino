void RC_IK(uint32_t linearPercent, uint32_t angularPercent) {

  int SignedRCLeftSpeed = (linearPercent - 1.5 * WheelSpacing * angularPercent);
  int SignedRCRightSpeed = (linearPercent + 1.5 * WheelSpacing * angularPercent);
